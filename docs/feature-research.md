...
- QR handoff (D-056): a laptop shows a QR code, the phone files the document without signing in, and the review opens on the laptop. Photos are reduced in the browser before upload.

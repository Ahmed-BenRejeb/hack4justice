"""Turns phone photos of a paper document into pages the OCR can read (G3, D-056).
...
# Written as the PDF's resolution. It mirrors RASTER_DPI in ocr.py (which imports
# this module, so it cannot be imported here): the page renders back at its own size.
PAGE_DPI = 150.0

/** Header of a file review: back link, short reference as the title, then organisation, filename, date and status. */
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0 space-y-1.5">
          ...
          <div className="flex min-w-0 flex-wrap items-center gap-x-4 gap-y-1 text-sm text-muted-foreground">
            ...
            <span>Déposé le {formatDateTime(document.created_at)}</span>
          </div>
        </div>

...
- Wire types live only in `lib/api-types.ts`. Shapes not fixed by docs/architecture.md are the assumptions listed in docs/decision-log.md D-017; change both together.

...
| 2026-09-13 | team | Phone capture: camera pages, photos reduced before upload, laptop QR code and the session-less `/capture/[token]` screen, `PUBLIC_WEB_URL` (D-055, D-056) |
